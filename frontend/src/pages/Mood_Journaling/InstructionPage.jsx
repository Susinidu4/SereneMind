...
export const InstructionPage = () => {
  ...
  useEffect(() => {
    ...
    // Ensure user data exists and has a role of "user" before enabling the button
        ...
        <div className={GlobalStyle.fontNunito}>
          ...
          <div className="mx-25 mt-12">
            <p className={GlobalStyle.paragraph}>
              Take a moment to reflect on your current emotional state and
              record your thoughts. Mood journaling is a powerful tool that
              helps you gain clarity and awareness about your feelings. By
              identifying and understanding your emotions, you can uncover
              patterns, triggers, and coping strategies that work best for you.
              This practice not only supports your mental well-being but also
              fosters personal growth, resilience, and self-compassion. Whether
              you're celebrating a joyful moment, processing a challenging
              experience, or simply checking in with yourself, journaling
              provides a safe space to express and explore your emotions.
              Remember, there's no right or wrong way to feel—this is your
