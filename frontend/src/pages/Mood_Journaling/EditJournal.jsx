        ...
        <div className={GlobalStyle.fontNunito}>
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-10">
              <div>
                <p className="text-lg font-semibold">Date: {new Date(journal.updatedAt).toLocaleDateString()}</p>
                <p className="text-lg font-semibold">Time: {new Date(journal.updatedAt).toLocaleTimeString()}</p>
                <div className="p-4 bg-[#A5D6A7] rounded-lg shadow-md mt-5">
                  <p className="text-lg font-semibold">Overall Mood: {journal.Overall_mood} </p>
